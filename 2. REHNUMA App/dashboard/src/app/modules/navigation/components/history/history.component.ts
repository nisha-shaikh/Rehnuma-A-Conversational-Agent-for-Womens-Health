import { Component, Directive, ViewChildren, QueryList, Input, Output, PipeTransform, OnInit } from '@angular/core';
...
export class TableComponent implements OnInit {
  ...
  showPastChats() {
    this.chatCollectionRef = this.db.collection<Chat>('chat', ref => ref.where('isActive', '==', false));
